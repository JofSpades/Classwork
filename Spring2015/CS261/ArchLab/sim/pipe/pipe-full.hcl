##################################################################
# pipe-full.hcl- meant to be the full application of the pipe    #
# simulator.													 #
#																 #
# Include your name and ID here.                                 #
# Maxwell Petersen/mpeter39										 #
# Describe how and why you modified the baseline code.           #
# I implamented the use of IIADDL and ILEAVE to save some cycles #
# in the ncopy program											 #
##################################################################
